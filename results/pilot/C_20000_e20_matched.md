...
| --- | ---: | ---: | ---: |
| 0: pick up the black bowl between the plate and the ramekin and place it on the plate | 50.0% (10/20) | 75.0% | -25.0 |
| 1: pick up the black bowl next to the ramekin and place it on the plate | 75.0% (15/20) | 85.0% | -10.0 |
| 2: pick up the black bowl from table center and place it on the plate | 80.0% (16/20) | 95.0% | -15.0 |
| 3: pick up the black bowl on the cookie box and place it on the plate | 60.0% (12/20) | 80.0% | -20.0 |
...
- Evaluation: 5917.9 s; total process: 5918.8 s.
- Policy latency, batch 5: mean 120.99 ms, median 118.63 ms, p95 137.18 ms over 10078 calls.
...
- Checkpoint: `local:/workspace/vla-semantic-controls/outputs/train/spatial_C/checkpoints/020000/pretrained_model` (weights SHA-256 `80805d15416e60268cba046dc55a76ef059b8ff84a405aea257d65dda5795fcf`).
- Semantic control: preset C (semantic_layers=cross_only, update_vlm=False; source checkpoint_file); routing verified: True on 16/32 coupled layers; training step 20000; init fingerprint `77cc336fa8786389`; parameter dtypes ['bfloat16', 'float32'].
...
- Per-task deltas: largest deficits are task(s) 8, 0, and 9; largest improvements are task(s) 6 and 7; the deficit is spread across tasks rather than a single-task protocol collapse.
