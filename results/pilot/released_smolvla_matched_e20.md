...
| 2: pick up the black bowl from table center and place it on the plate | 100.0% (20/20) | 95.0% | +5.0 |
...
| 8: pick up the black bowl next to the plate and place it on the plate | 95.0% (19/20) | 85.0% | +10.0 |
| 9: pick up the black bowl on the wooden cabinet and place it on the plate | 85.0% (17/20) | 75.0% | +10.0 |

## Runtime

- Evaluation: 5000.5 s; total process: 5007.3 s.
- Policy latency, batch 5: mean 116.02 ms, median 114.45 ms, p95 129.05 ms over 8068 calls.
- Peak VRAM: 2571 MiB by nvidia-smi; PyTorch allocated/reserved peaks: 1340.3/1454.0 MiB.
...
- Policy kind: `stock_released_smolvla`; semantic control active: False; config SHA-256 `e346a63094732ea2`; protocol SHA-256 `796598d68b5592a8`.
...
- Harness revision: `a2729b78949349c46c7f83853742d65f610d9646`; reference artifact: `https://github.com/zuoxingdong/smolvla-libero-eval.git@114d19c51bf7655e61fb994f3b344a0257ceb20b`.
...
- Observed 82.0% is +0.5 points from the 81.5% target and inside the configured +/-5.0-point band.
- The approximate Wilson 95% interval is 76.1-86.7%; it includes the 81.5% reference (whose own interval is 75.5-86.3%). Episode dependence makes this only a diagnostic.
- Per-task deltas: largest deficits are task(s) 4, 5, and 6; largest improvements are task(s) 3 and 9; the deficit is spread across tasks rather than a single-task protocol collapse.
